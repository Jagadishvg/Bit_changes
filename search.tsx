...
export function Search({ children }: SearchProps) {
  ...
  const gridClass = homeData.featureSection && homeData.featureSection.cardSize && homeData.featureSection.cardSize === 'small'
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-8 col-lg-9 pb-5 pb-lg-5">
            ...
            <div className="row gy-4 mt-2">
              {filteredProducts.length > 0 && paginatedProducts.map((section, index) => (
